    ...
    match t:
        case "local":
            return LMCacheEngineConfig.from_defaults(
                local_device="cuda", remote_url=None
            )
        case "remote":
            return LMCacheEngineConfig.from_defaults(
...
@pytest.mark.parametrize(
    "backend_type", ["local", "remote", "hybrid", "hybrid_pipelined"]
)
