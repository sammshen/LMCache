...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--host", type=str, default="localhost", help="Host name/IP for connection"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--num-objs", type=int, default=100, help="Number of objects to transfer"
    )
    parser.add_argument(
        "--simulate-work", action="store_true", help="Simulate some work on both sides"
    )
    ...
    for round_num in range(args.num_rounds):
        ...
        if args.role == "sender":
            ...
            for i, (received_obj, original_obj) in enumerate(zip(received_objs, objs)):
