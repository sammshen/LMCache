...
class KVSizeCalculator:
    ...
    def __init__(
        self, num_key_value_heads: int, head_dim: int, num_layers: int, precision: int
    ):
...
def parse_arguments():
    ...
    parser.add_argument(
        "--kv-precision-bit", type=int, default=16, help="KV cache precision bit"
    )
    parser.add_argument(
        "--base-url",
        type=str,
